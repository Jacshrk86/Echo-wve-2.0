...
const Toast: React.FC<ToastProps> = ({ type, message, onDismiss }) => {
  ...
  return (
    <div 
      className={`fixed top-5 right-5 flex items-center p-4 rounded-lg shadow-lg text-white ${bgColor} transform transition-all duration-300 ease-in-out animate-fade-in-down`}
      role="alert"
    >
